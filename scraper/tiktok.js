...
async function tiktok(url) {
    ...
    const titoko = `https://dia-rest-api.herokuapp.com/downloader/tiktoknowm?link=${url}`
    const tikitoko = `https://dia-rest-api.herokuapp.com/converter/tomp3?url=https://dia-rest-api.herokuapp.com/downloader/tiktoknowm?link=${url}`
    const obj = {
        videoInfo: {
            id: ingfo.id,
            desc: ingfo.text,
